...
class OrderRepositoryTest extends TestCase
{
    ...
    {
        $order = factory(Cart::class)->make()->toArray();
        ...
        $this->assertNotNull(Cart::find($createdOrder['id']), 'Order with given id must be in DB');
    ...
    {
        $order = factory(Cart::class)->create();
    ...
    {
        $order = factory(Cart::class)->create();
        $fakeOrder = factory(Cart::class)->make()->toArray();
    ...
    public function test_delete_order()
    {
        ...
        $this->assertNull(Cart::find($order->id), 'Order should not exist in DB');
    }
}
